...
def dodaj_korisnika():
    ...
    #treba proveriti i za mejl adresu isto da se ne poklapa sa nekom postojecom, moramo obezbediti da ova dva budu unique
...
@app.route('/platiFulVerziju/<string:korisnickoIme>', methods=["GET"])       #moram obezbediti da korisnicko ime bude jedinstveno!!!! to je odradjeno u kreiranju korisnika
